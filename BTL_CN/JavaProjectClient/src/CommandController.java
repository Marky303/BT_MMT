...
public class CommandController implements Runnable
{
    ...
    // Constructor
    public CommandController(ServerSocket bashSocket, ArrayList<String> fileList, List<String> fileLocationList)
    {
        ...
        try
        {
            ...
            this.client = new Client(socket,fileList,fileLocationList);
